$(function() {
	...
	$('.b-filter__item-1 .b-filter__link').on('click', function() {
		...
		$('.b-filter__item-2').removeClass('b-filter__item-active');
		$('.b-filter__item-3').removeClass('b-filter__item-active');
		$('.b-filter__item-4').removeClass('b-filter__item-active');
		$('.b-filter__item-5').removeClass('b-filter__item-active');
		$('.b-filter__item-6').removeClass('b-filter__item-active');
	...
	$('.b-filter__item-2 .b-filter__link').on('click', function() {
		...
		$('.b-filter__item-1').removeClass('b-filter__item-active');
		$('.b-filter__item-3').removeClass('b-filter__item-active');
		$('.b-filter__item-4').removeClass('b-filter__item-active');
		$('.b-filter__item-5').removeClass('b-filter__item-active');
		$('.b-filter__item-6').removeClass('b-filter__item-active');
	...
	$('.b-filter__item-3 .b-filter__link').on('click', function() {
		...
		$(this).parent().toggleClass('b-filter__item-active');
		$(this).parent().children('.b-filter__list-3').stop(false, true).slideToggle();
		$(document).click(function(event) {
			if ($(event.target).closest('.b-filter__list').length) return;
				$('.b-filter__item').removeClass('b-filter__item-active');
				$('.b-filter__list').slideUp();
	...
	$('.b-filter__item-4 .b-filter__link').on('click', function() {
		...
		$(this).parent().toggleClass('b-filter__item-active');
		$(this).parent().children('.b-filter__list-4').stop(false, true).slideToggle();
		$(document).click(function(event) {
			if ($(event.target).closest('.b-filter__list').length) return;
				$('.b-filter__item').removeClass('b-filter__item-active');
				$('.b-filter__list').slideUp();
	...
	$('.b-filter__item-5 .b-filter__link').on('click', function() {
		...
		$(this).parent().toggleClass('b-filter__item-active');
		$(this).parent().children('.b-filter__list-5').stop(false, true).slideToggle();
		$(document).click(function(event) {
			if ($(event.target).closest('.b-filter__list').length) return;
				$('.b-filter__item').removeClass('b-filter__item-active');
				$('.b-filter__list').slideUp();
	...
	$('.b-filter__item-6 .b-filter__link').on('click', function() {
		...
		$(this).parent().toggleClass('b-filter__item-active');
		$(this).parent().children('.b-filter__list-6').stop(false, true).slideToggle();
		$(document).click(function(event) {
			if ($(event.target).closest('.b-filter__list').length) return;
				$('.b-filter__item').removeClass('b-filter__item-active');
				$('.b-filter__list').slideUp();
